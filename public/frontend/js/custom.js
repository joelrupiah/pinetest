...
//===Google Map  js===
    ...
    if (document.getElementById("map")) {
        ...
        function init() {
            var mapOptions = {
                zoom: 11,
                center: new google.maps.LatLng(-1.1164888727979032, 37.0391896141954), // New York
                styles: [{
                    "featureType": "water",
            ...
            var marker = new google.maps.Marker({
                position: new google.maps.LatLng(-1.1164888727979032, 37.0391896141954),
                map: map,
                title: 'Pinecrest Academy Location'
            });
        }
    }
