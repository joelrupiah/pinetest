                    ...
                    <div class="card-body">
                      <div class="list-group list-group-flush my-n3">
                        <div class="list-group-item">
                          <div class="row align-items-center">
                            <div class="col-3 col-md-2">
                              <img src="/backend/assets//products/p1.jpg" alt="..." class="thumbnail-sm">
                            </div>
                            <div class="col">
                        ...
                        <div class="list-group-item">
                          <div class="row align-items-center">
                            <div class="col-3 col-md-2">
                              <img src="/backend/assets//products/p2.jpg" alt="..." class="thumbnail-sm">
                            </div>
                            <div class="col">
                        ...
                        <div class="list-group-item">
                          <div class="row align-items-center">
                            <div class="col-3 col-md-2">
                              <img src="/backend/assets//products/p3.jpg" alt="..." class="thumbnail-sm">
                            </div>
                            <div class="col">
                        ...
                        <div class="list-group-item">
                          <div class="row align-items-center">
                            <div class="col-3 col-md-2">
                              <img src="/backend/assets//products/p4.jpg" alt="..." class="thumbnail-sm">
                            </div>
                            <div class="col">
