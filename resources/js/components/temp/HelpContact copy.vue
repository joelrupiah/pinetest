<template>
    <section class="contact-details-area mb-3">
                    ...
                    <div class="card">
                        <div class="flip-card">
                            <div class="flip-card__container">
                                ...
                                <div class="card-back">
                                    <!-- <iframe class="video__container" src="frontend/videos/Welcome to Pinecrest Academy.mp4"
                                        frameborder="0" allow="autoplay=0; encrypted-media; picture-in-picture"
                                        allowfullscreen>
                                    </iframe> -->
