        ...
        <div class="rev_slider fullwidthabanner" id="rev_slider_two" data-version="5.4.1">
          <ul>
            <li data-description="Slide Description" data-easein="default" data-easeout="default"
              ...
              data-param10="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7=""
              data-param8="" data-param9="" data-rotate="0" data-saveperformance="off" data-slotamount="default"
              ...
              <div class="tp-caption" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                ...
                data-height="none" data-width="['800','800','700','400']" data-whitespace="normal"
              ...
              <div class="tp-caption" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                data-paddingright="[0,0,0,0]" data-paddingtop="[0,0,0,0]" data-responsive_offset="on" data-type="text"
                data-height="none" data-width="['800','800','700','400']" data-whitespace="normal"
                data-hoffset="['15','15','15','15']" data-voffset="['25','0','-5','-20']"
                data-x="['left','left','left','left']" data-y="['middle','middle','middle','middle']"
                data-textalign="['top','top','top','top']"
            ...
            <li data-description="Slide Description" data-easein="default" data-easeout="default"
              ...
              data-transition="parallaxvertical">
              <img alt="" class="rev-slidebg" data-bgfit="cover" data-bgparallax="10" data-bgposition="center center"
                data-bgrepeat="no-repeat" data-no-retina="" src="frontend/images/slides/slide-two.jpg" />
            ...
            <li data-description="Slide Description" data-easein="default" data-easeout="default"
              ...
              data-transition="parallaxvertical">
              <img alt="" class="rev-slidebg" data-bgfit="cover" data-bgparallax="10" data-bgposition="center center"
                data-bgrepeat="no-repeat" data-no-retina="" src="frontend/images/slides/slide-three.jpg" />
              ...
              <div class="appointment">
                <form class="appointment-form">
                  ...
                  <div class="row">
                    ...
                    <div class="col-xl-6">
                      <div class="single-box">
                        ...
                        <el-select v-model="form.grade_id" placeholder="Choose Grade (required)" size="mini"
                          style="width: 100%">
                  ...
                  <div class="row">
                    <div class="col-xl-6">
                      <div class="single-box">
                        <el-button :loading="loading" size="mini" style="background-color: #023020; color: white"
...
export default {
  ...
  methods: {
    ...
    statusColor: function (status) {
      let data = {
        0: "badge badge-dark", 1: "badge badge-warning",
