<template>
    <div id="enquiry-and-admission">
        <notifications group="application" position="bottom right" class="mb-5" />
        <notifications group="enquiry" position="bottom right" class="mb-5" />
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="text">
                                                        ...
                                                        <p>The administration will review the application and provide an
                                                            update.</p>
                                                    </div>
                                                </li>
                                                <li>
                                                    ...
                                                    <div class="text">
                                                        ...
                                                        <p>After successful consideration, you and the child will be
                                                ...
                                                <li>
                                                    ...
                                                    <div class="text">
                                                        ...
                                                        <p>If the interview is successful, you will be sent an admission
                                                            form which you will
                                        ...
                                        <div class="additional-info-content-box">
                                            <div class="accordion-box">
                                                ...
                                                <div class="accordion accordion-block"
                                                    v-for="(adminfaq, index) in adminfaqs" :key="index">
                            ...
                            <div class="appointment">
                                <form class="appointment-form" style="padding-bottom: 22px;">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="single-box">
                                                <small class="font-weight-bold text-danger text-sm" v-if="errors.message">
                                                    {{ errors.message[0] }}
                                                </small>
                                                <el-input type="textarea" :autosize="{ minRows: 6, maxRows: 10 }"
                                                    placeholder="Message (required)" size="mini"
                            ...
                            <div class="appointment">
                                <form class="appointment-form">
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="single-box">
                                                <small class="font-weight-bold text-danger text-sm" v-if="errors.parent_name">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="single-box">
                                                <small class="font-weight-bold text-danger text-sm" v-if="errors.parent_phone">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="single-box">
                                                <small class="font-weight-bold text-danger text-sm" v-if="errors.parent_email">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="single-box">
                                                <small class="font-weight-bold text-danger text-sm" v-if="errors.student_name">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="single-box">
                                                <small class="font-weight-bold text-danger text-sm" v-if="errors.student_age">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="single-box">
                                                <small class="font-weight-bold text-danger text-sm" v-if="errors.grade_id">
                                                    {{ errors.grade_id[0] }}
                                                </small>
...
export default {
    ...
    methods: {
        ...
        sendEnquiry: async function () {
            axios
                .post("/submit-enquiry", this.enquiryform)
                .then(() => {
                    this.$notify({
                        group: 'enquiry',
                        type: 'success',
