...
class GalleryController extends Controller
{
    ...
    {
        $socialeventsGalleries = Gallery::with('category')->where('category_id', 7)->paginate($request->total);
    ...
    {
        $infrastructureGalleries = Gallery::with('category')->where('category_id', 8)->paginate($request->total);
