...
class GalleryController extends Controller
{
    ...
    {
        $educationGalleries = Gallery::inRandomOrder()->take(4)->with('category')->where('category_id', 1)->paginate($request->total);
    ...
    {
        $sportGalleries = Gallery::inRandomOrder()->take(4)->with('category')->where('category_id', 2)->paginate($request->total);
    ...
    {
        $agricultureGalleries = Gallery::inRandomOrder()->take(4)->with('category')->where('category_id', 3)->paginate($request->total);
    ...
    {
        $socialeventsGalleries = Gallery::inRandomOrder()->take(4)->with('category')->where('category_id', 4)->paginate($request->total);
    ...
    {
        $infrastructureGalleries = Gallery::inRandomOrder()->take(4)->with('category')->where('category_id', 5)->paginate($request->total);
